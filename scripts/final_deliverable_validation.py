...
def main():
    ...
    org_passed, orgtotal = check_directory_structure()
    arch_passed, archtotal = check_service_architecture()
    docs_passed, docstotal = check_documentation()
    infra_passed, infratotal = check_development_infrastructure()
    business_passed, businesstotal = check_business_logic()

    # Calculate overall completion
    totalpassed = org_passed + arch_passed + docs_passed + infra_passed + business_passed
    totalchecks = org_total + arch_total + docs_total + infra_total + business_total
    completionpercentage = (total_passed / total_checks) * 100
