...
"""
    ...
    shared_tests_dir = Path("shared/tests")
...
'''
    ...
    email_service_dir = Path("services/email-service/tests")
    if not (email_service_dir / "test_email_processor.py").exists():
        email_service_dir.mkdir(parents=True, exist_ok=True)
        (email_service_dir / "test_email_processor.py").write_text(email_service_test)
...
'''
    ...
    db_service_dir = Path("services/database-service/tests")
