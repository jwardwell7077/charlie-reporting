...
def main():
    ...
    gmailaddress = env_content.get('GMAIL_ADDRESS', 'NOT SET')
    gmailpassword = env_content.get('GMAIL_APP_PASSWORD', 'NOT SET')
    targetemail = env_content.get('TARGET_EMAIL', 'NOT SET')
    ...
    try:
        ...
        body = """🎉 SUCCESS! Email system is working!
