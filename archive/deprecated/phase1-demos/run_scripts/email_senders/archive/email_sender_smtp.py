...
class EmailSender:
    def __init__(self, config_path: str = None):
        ...
        self.senderpassword = getpass.getpass("Enter your Gmail App Password: ")
...
Automated Report Distribution System"""
    ...
    def send_single_csv_email(self, csv_file_path: str, report_type: str,
        ...
        try:
            ...
            body_templates = {
                "ACQ": """Please find attached the latest acquisition metrics report.
...
Call Center Reporting System""",
                ...
                "Campaign_Interactions": """Please find attached the campaign interactions report.
...
Call Center Reporting System""",
                ...
                "Dials": """Please find attached the dialing activity report.
...
Call Center Reporting System""",
                ...
                "IB_Calls": """Please find attached the inbound calls report.

Report Period: {timestamp.strftime('%Y-%m-%d %H:%M')}
Report Type: {interval_type.title()} Inbound Call Data
File: {os.path.basename(csv_file_path)}

This report includes inbound call volumes, wait times,
and customer service metrics.

Best regards,
Call Center Reporting System""",

                "Productivity": """Please find attached the agent productivity report.
...
Call Center Reporting System""",
                ...
                "QCBS": """Please find attached the quality & compliance report.

Report Period: {timestamp.strftime('%Y-%m-%d %H:%M')}
Report Type: {interval_type.title()} Quality Data
File: {os.path.basename(csv_file_path)}

This report includes quality scores, compliance metrics,
and call monitoring results.

Best regards,
Call Center Reporting System""",

                "RESC": """Please find attached the resource utilization report.
...
Call Center Reporting System"""
            ...
            # Add body
            body = body_templates.get(report_type, """Please find attached the {report_type} report.
...
Call Center Reporting System""")
    ...
    def send_test_email(self) -> bool:
        ...
        try:
            ...
            body = """This is a test email from the Charlie Reporting System.
