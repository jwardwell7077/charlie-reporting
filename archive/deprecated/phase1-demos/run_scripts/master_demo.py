...
class MasterDemo:
    def __init__(self):
        ...
        self.demo_root = get_demo_root()
        self.project_root = get_project_root()
        self.python_exe = get_python_executable()
        self.demo_config = self.demo_root / "config.toml"
    ...
    def step_1_generate_data(self):
        ...
        data_generator = get_relative_script_path("data_generator.py", "data_generation")
    ...
    def step_2_send_emails(self):
        ...
        email_sender = get_relative_script_path("focused_email_sender.py", "email_senders")
    ...
    def step_3_process_emails(self):
        ...
        print(f"🔄 Running Charlie Reporting System...")
    ...
    def step_4_verify_results(self):
        ...
        output_dir = self.demo_root / "data" / "output"
        archive_dir = self.demo_root / "data" / "archive"
        raw_dir = self.demo_root / "data" / "raw"
