...
def demo_hourly_processing():
    ...
    try:
        ...
        current_hour_data = processor.process_hourly()
        ...
        specific_hour_data = processor.process_hourly(two_hours_ago)
        ...
        report_path = processor.generate_on_demand_report(today)
        if report_path:
        ...
        summary_path = processor.generate_end_of_day_summary(today)
        if summary_path:
