...
def create_test_csv():
    ...
    csv_filename = f"IB_Calls_{timestamp}.csv"
    ...
    with open(csv_path, 'w', newline='') as csvfile:
        ...
        # Write sample data
        for agent in agents:
            handle_count = random.randint(15, 45)
            avg_handle = round(random.uniform(180, 420), 1)  # 3-7 minutes in seconds
...
def send_test_email_with_csv():
    ...
    # Create test CSV
    csv_path, csv_filename = create_test_csv()
