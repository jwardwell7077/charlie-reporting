...
def test_business_services_structure():
    ...
    existingfiles = [f.name for f in business_services.glob("*.py") if f.is_file()]
...
def test_api_routes_structure():
    ...
    routesfile = api_routes / "reports.py"
...
def test_requirements_file_exists():
    ...
    servicerequirements = service_root / "requirements.txt"

    # Or check for requirements at project level
    projectrequirements = service_root.parent.parent / "requirements.txt"
...
def test_business_logic_separation():
    ...
    businessdir = service_root / "src" / "business"

    if not business_dir.exists():
        pytest.skip("Business directory not found")

    # Check for proper separation
    businessfiles = list(business_dir.rglob("*.py"))
