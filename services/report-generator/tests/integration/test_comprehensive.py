...
class TestDataIntegrity:
    ...
    async def test_data_consistency(
        ...
        for csv_file in sample_csv_files:
            ...
            original_data[csv_file.file_name] = {
                'row_count': len(df),
        ...
        transformcalls = all_mock_services['csv_transformer'].get_call_history('transform_csv')
