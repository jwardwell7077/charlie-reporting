...
Bob Johnson,2025 - 01 - 15,7,1750.00,Winter Promo"""
    ...
    def test_validate_files_endpoint(self, mock_csv_service, client, sample_csv_content):
        ...
        mock_service = Mock()
        mock_csv_service.returnvalue = mock_service
        mock_service.validate_csv_file.returnvalue = {
            "is_valid": True,
            "errors": [],
            "warnings": [],
            "row_count": 3,
    ...
    def test_transform_endpoint(self, mock_csv_service, client, sample_csv_content):
        ...
        mock_result.transformeddata = mock_df
        mock_result.errormessage = None

        mock_service.create_transformation_rules.returnvalue = []
        mock_service.transform_csv_file.returnvalue = mock_result
    ...
    def test_process_endpoint(self, mock_excel_service, mock_csv_service, client):
        ...
        mock_csv = Mock()
        mock_excel = Mock()
        mock_csv_service.returnvalue = mock_csv
        mock_excel_service.returnvalue = mock_excel

        mock_csv.create_transformation_rules.returnvalue = []
...
class TestReportGeneratorAPIErrorHandling:
    ...
    def test_transform_service_failure(self, mock_csv_service, client):
        ...
        mock_service = Mock()
        mock_csv_service.returnvalue = mock_service
        mock_service.create_transformation_rules.sideeffect = Exception("Service error")
