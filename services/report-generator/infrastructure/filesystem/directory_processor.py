...
Production implementation of IDirectoryProcessor interface for file system operations.
"""
...
class DirectoryProcessorImpl(IDirectoryProcessor):
    ...
    def __init__(self):
        self._supported_extensions = {'.csv'}
    ...
    def _scan_directory_sync(self, directory_path: Path) -> List[Path]:
        ...
        for pattern in patterns:
            ...
            for match in matches:
                ...
                # Validate file
                if self._is_valid_csv_file(file_path):
    ...
    def _is_valid_csv_file(self, file_path: Path) -> bool:
        """
