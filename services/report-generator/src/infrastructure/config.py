...
class ConfigurationManager:
    ...
    def _load_configuration(self):
        ...
        self._update_service_config(config_data)
        
        # Validate configuration
        self._validate_configuration()
        
        self.config_loaded_at = datetime.utcnow()
    ...
    def _load_environment_variables(self) -> Dict[str, Any]:
        ...
        env_mappings = {
            ...
            f"{prefix}ENABLE_CORS": ("enable_cors", self._parse_bool),
            f"{prefix}ENABLE_METRICS": ("enable_metrics", self._parse_bool),
    ...
    def _update_service_config(self, config_data: Dict[str, Any]):
