...
class IntegrationDataGenerator:
    ...
    def __init__(self, config):
        ...
        self.attachment_rules = config.attachments
    ...
    def generate_test_csv(self, csv_type: str, temp_dir: str, num_rows: int = 10) -> str:
        ...
        data = self._generate_data_for_type(csv_type, columns, num_rows)
    ...
    def generate_multiple_csvs(self, temp_dir: str, csv_types: Optional[List[str]] = None) -> List[str]:
        ...
        if csv_types is None:
            csv_types = ['IB_Calls', 'Dials', 'Productivity']  # Common test types
        
        generated_files = []
        for csv_type in csv_types:
            try:
                file_path = self.generate_test_csv(csv_type, temp_dir)
    ...
    def _generate_data_for_type(self, csv_type: str, columns: List[str], num_rows: int) -> Dict[str, List]:
