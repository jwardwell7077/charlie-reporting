...
class StructuredFormatter(logging.Formatter):
    ...
    def __init__(self, service_name: str, include_extra: bool = True):
        ...
        self.includeextra = include_extra
...
class ServiceLogger:
    ...
    def add_file_handler(self, log_file_path: str | Path,
        ...
        logfile_path = Path(log_file_path)
...
class LoggerContext:
    ...
    def debug(self, message: str, **extra):
        ...
        combinedextra = {**self.context, **extra}
...
request_logger.log_request_start(request_id, "GET", "/health")  # ... process request ...
request_logger.log_request_end(request_id, "GET", "/health", 200, 45.2)

# Business operation logging
oplogger = BusinessOperationLogger(logger)
opid = create_operation_id()
op_logger.log_operation_start(op_id, "email_fetch")  # ... process operation ...
